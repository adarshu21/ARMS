...
# app = FastAPI()
#
# # Load the TensorFlow model from a different Python script
# model = tf.keras.models.load_model("mymodel/warm")
#
# @app.post("/predict")
...
def matcher(img1, img2):
    ...
    result = cv2.drawMatchesKnn(img1, keypoints1, img2, keypoints2, good_matches, None,
